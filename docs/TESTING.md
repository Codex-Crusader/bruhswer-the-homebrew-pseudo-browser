...
| `test_reverification.py` | 23 | nothing | What counts as a control that stopped holding, the worker's threading contract, and the one-shot async verify behind startup() and the BRUH CHECK panel |
